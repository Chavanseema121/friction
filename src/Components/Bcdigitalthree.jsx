      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Creating valuable content to attract, engage, and retain customers.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  Basics and importance of content<br></br> marketing for business success.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Planning and creating a comprehensive<br></br> content marketing strategy.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Understanding and identifying target<br></br> audience needs and preferences.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Crafting engaging and relevant content<br></br> for various platforms.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Strategies for effectively distributing<br></br> content across multiple channels.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Enhancing content visibility and search<br></br> engine ranking.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Techniques to amplify content reach<br></br> through paid and organic methods.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  {" "}
                  <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">
                  Analytics and Performance<br></br> Measurement
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Tracking and analyzing content<br></br> performance to refine strategies.
                  </p>
                </div>
              </div>
