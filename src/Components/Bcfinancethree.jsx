      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Understanding how blockchain technology transforms financial systems and processes.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  Introduction to Blockchain in<br></br> Finance
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Overview of blockchain applications in<br></br> the financial industry.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Exploring the role of cryptocurrencies and digital<br></br> assets in finance.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Implementing and using smart contracts<br></br> for financial transactions.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Understanding DeFi platforms and their impact <br></br>on traditional finance.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Enhancing payment systems with<br></br> blockchain technology for speed and<br></br> security.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Applications of blockchain in banking<br></br> operations and services.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Navigating the regulatory landscape for<br></br> blockchain in finance.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Addressing security and privacy issues in <br></br>blockchain-based financial systems.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Exploring emerging trends and future<br></br> developments in blockchain finance.
                  </p>
                </div>
              </div>
