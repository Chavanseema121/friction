      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Creating impactful email campaigns to nurture leads and customers.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  Basics and benefits of email marketing for<br></br> business growth.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Strategies to grow and segment your<br></br> subscriber list effectively.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Crafting visually appealing and engaging<br></br> email designs.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Writing compelling content that drives<br></br> engagement and conversions.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Setting up automated email sequences to <br></br>nurture leads.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Techniques to test and optimize your email<br></br> campaigns.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Measuring and analyzing the performance<br></br> of email marketing efforts.
                  </p>
                </div>
              </div>
