      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Master essential principles for launching and growing a successful startup.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  Understanding the startup ecosystem, key<br></br> concepts, and entrepreneurial mindset.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Techniques for validating and refining<br></br> your startup idea and market fit.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Developing a comprehensive business<br></br> plan outlining goals and strategies.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Exploring funding options and preparing<br></br> for investor pitches.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Strategies for recruiting, hiring, and<br></br> managing a strong startup team.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Planning and executing effective go-to-<br></br>market strategies for your product.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Methods for scaling operations, growth<br></br> strategies, and managing expansion.
                  </p>
                </div>
              </div>
