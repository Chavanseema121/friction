      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Harness the power of AI to understand and generate human language.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  Overview of NLP concepts, applications,<br></br> and real-world use cases.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Cleaning and preparing text data for<br></br> effective analysis.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Breaking down text into tokens and<br></br> creating word embeddings.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  {" "}
                  <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">
                  Part-of-Speech Tagging and Named<br></br> Entity Recognition
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Identifying grammatical elements and <br></br>entities within text.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Analyzing and determining the sentiment<br></br> of text data.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  {" "}
                  <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">
                  Language Modeling and Sequence-<br></br>to-Sequence Models
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Building models to predict and generate<br></br> text sequences.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Using transformer-based models like BERT<br></br> for advanced NLP tasks.
                  </p>
                </div>
              </div>
              <div className="w-full ">
