      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Employee Engagement focuses on fostering a positive work environment to boost employee motivation and productivity.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  Introduction to Employee<br></br> Engagement
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Understanding the importance of<br></br> employee engagement and its impact on<br></br> performance.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Implementing effective strategies to<br></br> enhance employee commitment and<br></br> satisfaction.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Encouraging open communication and<br></br> regular feedback to build trust and<br></br> collaboration.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Developing recognition programs to<br></br> acknowledge and reward employee<br></br> contributions..
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Promoting work-life balance to reduce<br></br> burnout and increase job satisfaction.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Offering growth and development<br></br> opportunities to keep employees<br></br> motivated and engaged.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Utilizing surveys and metrics to assess<br></br> and improve engagement levels.
                  </p>
                </div>
              </div>
