  ...
  return (
    <div className="w-full h-auto bg-white p-8">
      ...
      <div className="flex justify-between w-full h-[42px] mt-[50px]">
        ...
        <div className="">
          <button className="flex items-center bg-white border border-gray-600 px-4 py-2 rounded-full w-[159px] h-[42px] mr-[102px] ">
            <span>Sort</span>
            <img
              src={arr}
              alt="Arrow Icon"
          ...
          <div className="bg-white p-4  border-r border-0 border-orange-500">
            ...
            <ul className="list-none text-[#1D2228] pl-4">
              ...
              <div className="list-disc  pl-4 ">
                <li className=" mb-2 text-[16px] font-medium font-Lato font-sans border-b-2 w-[200px] border-black ">
                  Mobile Development
                </li>
        ...
        <div className="w-3/4 mt-[76px]">
          ...
          <div className="bg-white">
            ...
            <p className="text-[#1D2228] mt-[19px] font-Lato font-sans text-[16px] font-semibold mb-[44px]">
              Learn to create innovative and functional apps for mobile devices.
            </p>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                    Core concepts and syntax for Android and<br></br> iOS app
                    development.
                  </p>
                </div>
              </div>
