      ...
      <div className="flex mt-[58px]  ml-[96px]">
        ...
        <div className="w-1/6  mt-[70px]">
          ...
          <ul className="list-none text-[#1D2228] mt-2  border-r border-orange-500 ">
            ...
            <div className="list-disc  pl-6 ">
              <li className=" mb-2 text-[16px] font-medium font-Lato font-sans border-b border-black w-[120px] ">
                Deep Learning
              </li>
        ...
        <div className="w-3/4 pl-[13px] mt-[76px]">
          ...
          <div className="bg-white ">
            ...
            Dive deep into advanced neural networks and machine learning techniques.
            </p>
            <div className="grid grid-cols-3 gap-[32px]">
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Techniques for image recognition and<br></br> processing using CNNs.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Implementing RNNs for sequential data<br></br> and time-series analysis.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  ...
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Applying deep learning to understand and <br></br>generate human language.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  {" "}
                  <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">
                  Generative Adversarial Networks<br></br> (GANs)
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Creating new data with GANs through<br></br> generative modeling.
                  </p>
                </div>
              </div>
              <div className="w-full ">
                ...
                <div className="ml-[10px]">
                  {" "}
                  <p className="text-[#1D2228]  font-bold text-[16px] font-Lato font-sans mb-2">
                  Deep Learning Frameworks and<br></br>Tools
                  </p>
                  <p className="text-[14px] font-Regular font-Lato font-sans mb-2">
                  Utilizing frameworks like TensorFlow,<br></br> Keras, and PyTorch for development.
                  </p>
                </div>
              </div>
            </div>
